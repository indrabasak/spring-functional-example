...
import com.basaki.example.data.entity.BookEntity;
import com.basaki.example.data.repository.BookRepository;
...
public class BookService {
    ...
    private static final MessageFormat BOOK_NOT_FOUND_MSF_FMT =
            new MessageFormat("Book with id {0} not found!");
    ...
    public void delete(UUID id) {
        try {
            ...
            throw new DataNotFoundException(
                    BOOK_NOT_FOUND_MSF_FMT.format(args));
        }
    }
